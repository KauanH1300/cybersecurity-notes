...
![Camadas de um sistema computacional](./imagens/Diagrama_de_sistemas.webp)
...
- como processos são criados e controlados  
- como o software conversa com o hardware  

Sem isso, dá até pra aprender ferramentas, mas tudo fica meio superficial.  
Com isso, aos poucos, as peças começam a se encaixar
...
Essa pasta existe justamente pra isso:  
registrar o caminho, não só o resultado final 🌱

---

## 📚 O que tem aqui dentro

Você vai encontrar conteúdos ligados a:

- fundamentos de sistemas computacionais  
- noções de arquitetura e organização do computador  
- memória, CPU e execução de instruções  
- processos, threads e gerenciamento de recursos  
- conceitos básicos de sistemas operacionais  

Tudo com foco em entender o funcionamento, não só decorar definição.
